...
@section('content')
    ...
    <div class="bg-white border shadow-lg">
        <div class="text-main font-bold secondary-bg p-4">Tabel Barang Keluar</div>
        <div class="p-4">
            <div class="flex justify-between">
                <div class="flex items-center">
                    Show
                    <form id="paginationForm" action={{route('barangkeluar.index')}} method="GET" class="mx-2">
            ...
            <div class="mt-6">
                <a href={{route('barangkeluar.create')}} class="main-bg text-white p-2 rounded">Tambah Barang Keluar</a>
            </div>
            <table class="table-auto border-collapse w-full mt-6">
                <thead>
                    <tr>
                        <th class="border-2">ID</th>
                        <th class="border-2">Tanggal Keluar</th>
                        <th class="border-2">Kuantitas Keluar</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-2 text-center">{{$item->tgl_keluar}}</td>
                        <td class="border-2 text-center">{{$item->qty_keluar}}</td>
                        ...
                        <td class="border-2 text-center">
                            <div class="flex justify-evenly">
                                <a href={{route('barangkeluar.show', $item->id)}}><i class="fa-regular fa-eye text-white main-bg p-2 rounded"></i></a>
                                <a href={{route('barangkeluar.edit', $item->id)}}><i class="fa-solid fa-pen-to-square text-white warning-bg p-2 rounded"></i></a>
